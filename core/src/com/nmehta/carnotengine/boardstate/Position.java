...
public class Position implements Comparable<Position> {
    ...
    private long pawnPieces;
    private long rookPieces;
    private long knightPieces;
    private long bishopPieces;
    private long queenPieces;
    private long kingPieces;
    ...
    public Position(){
        whitePieces =   0b1111111111111111000000000000000000000000000000000000000000000000L;
        blackPieces =   0b0000000000000000000000000000000000000000000000001111111111111111L;
        pawnPieces =    0b0000000011111111000000000000000000000000000000001111111100000000L;
        rookPieces =    0b1000000100000000000000000000000000000000000000000000000010000001L;
        knightPieces =  0b0100001000000000000000000000000000000000000000000000000001000010L;
        bishopPieces =  0b0010010000000000000000000000000000000000000000000000000000100100L;
        queenPieces =   0b0001000000000000000000000000000000000000000000000000000000010000L;
        kingPieces =    0b0000100000000000000000000000000000000000000000000000000000100000L;
        initPST2();
    }
    ...
    public long getPawnPieces(){
        return pawnPieces;
    }
    public long getRookPieces(){
        return rookPieces;
    }
    public long getKnightPieces(){
        return knightPieces;
    }
    public long getBishopPieces(){
        return bishopPieces;
    }
    public long getQueenPieces(){
        return queenPieces;
    }
    public long getKingPieces(){
        return kingPieces;
    }
